...
const FeaturedRoom: FC<Props> = props => {
    ...
    <section className="flex md:flex-row flex-col px-4 py-10 items-center gap-12 container">
        <div className="mn: grid gap-8 grid-cols-1">
            <div className="rounded-2xl overflow-hidden h-48 mb-4 md:md-0">
                <Image 
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
                    <div className="flex mb-3 md:mb-0">
                        <div className="flex gap-3 flex-col items-center justify-center mr-4">
                            ...
                            <p className="md:fond-bold flex font-medium text-lg xl:text-5xl">${featuredRoom.price}</p>
                        </div>
                        <div className="flex gap-3 flex-col items-center justify-center mr-4">
                            <p className="text-xs lg:text-xl text-center">Discount</p>
                            <p className="md:fond-bold flex font-medium text-lg xl:text-5xl">${featuredRoom.discount}</p>
                        </div>
                    </div>
                    <Link href={`/rooms/${featuredRoom.slug.current}`} 
                    className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 px-7 rounded-2xl font-bold lg:text-xl">
                    More Details
                    </Link>
                </div>
        </div>     
