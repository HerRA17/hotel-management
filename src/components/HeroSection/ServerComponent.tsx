...
export const heading1 = (
    <>
        ...
        That's why we offer a diverse selection of hotels, each tailored to different styles and requirements. 
        Whether you're in search of sleek, modern accommodations equipped with the latest technology, luxurious retreats rich with opulent amenities,
